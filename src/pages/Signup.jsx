...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let findUser = arr.find((user) => user.email === obj.email);
    if (findUser) {
...
<!-- Page Container --> */}
      <div
        id="page-container"
        className="signup mx-auto flex min-h-dvh w-full min-w-[320px] flex-col bg-gray-100 dark:bg-gray-900 dark:text-gray-100"
      >
        {/* Page Content */}
          ...
          <div className="relative mx-auto flex min-h-dvh w-full max-w-10xl items-center justify-evenly overflow-hidden p-4 lg:p-8">
            ...
            <section className="w-full max-w-xl py-6">
              ...
              <header className="mb-10 text-center">
                ...
                <h2 className="text-md font-medium text-white dark:text-gray-400 mt-2">
